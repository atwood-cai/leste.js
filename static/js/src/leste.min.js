...
$.ready(function(){var t,e,n=document,o={},a=0,u=0,c="pageX",i="pageY",s="target",h=setTimeout;n.on("touchstart",function(n){t=n.touches[0],o.x1=t[c],o.y1=t[i],o.ele="tagName"in t[s]?t[s]:t[s].parentNode,o.last=(new Date).getTime(),e&&clearTimeout(e)}),n.on("touchmove",function(e){t=e.touches[0],o.x2=t[c],o.y2=t[i],a+=Math.abs(o.x1-o.x2),u+=Math.abs(o.y1-o.y2)}),n.on("touchend",function(t){"last"in o&&(30>a&&30>u?e=h(function(){e=h(function(){e=null,o.ele.trigger("tap","CustomEvent",{touchstart:o.last,touchList:t.changedTouches})},250)},0):o={},a=u=0)})});
