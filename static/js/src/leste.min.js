!function(){function e(e){return t.test(e)?r(e):a.querySelector(e)}function n(e){return a.querySelectorAll(e)}function r(e){var n=a.createElement("div");n.innerHTML=e;for(var r=n.childNodes,t=a.createDocumentFragment(),o=r.length-1;o>=0;o--)t.appendChild(r[o]);return t}var t=/^\s*<(\w+|!)[^>]*>/,a=document,o=window;o.$=e,o.$$=n;var d={ready:function(e){4===a.readyState?e():a.addEventListener("DOMContentLoaded",e)},extend:function(e){var n,r=arguments;e=e||{};for(var t=1;t<r.length;t++)if(n=r[t])for(var a in n)n.hasOwnProperty(a)&&(e[a]=n[a]);return e}};d.extend(e,d)}();
...
!function(){function n(n){return n.split(" ")[i](function(n){return n.trim()})}var t="__handlers",e="removeEventListener",r="forEach",i="filter",o={};o.click=o.mousedown=o.mouseup=o.mousemove="MouseEvents";var u={on:function(e,i){var o=this;return n(e)[r](function(n){o[t]||(o[t]=[]),o[t].push(i),o.addEventListener(n,i,!1)}),o},off:function(i,o){var u=this;return n(i)[r](function(n){o?(u[e](n,o),u[t][r](function(n,e){n.toString()==o.toString()&&u[t].splice(e,1)})):u[t][r](function(t,r){u[e](n,t)})}),u},trigger:function(n,t){var e=null;return e=document.createEvent(o[n]||"Events"),e.initEvent(n,!0,!1),e.data=t,this.dispatchEvent(e),this}};["on","off","trigger"][r](function(n){Node.prototype[n]=u[n]})}();
